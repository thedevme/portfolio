        ...
        <div className="m-image-large">
          <div className="image">
            <div
              ...
              style={{
                backgroundImage: "url(assets/images/hornets-header.png)",
                width: "100%",
              }}
            />
          </div>
      ...
      <section className="section section-inner">
          ...
          <div className="container my-5">
            <div className="row">
              ...
              <div className="col-lg-6 mb-4">
                ...
                >
                  <img
                    src="/assets/images/hornets1.png"
                    alt="Roster Screen"
                    style={{
                  ...
                  <h2 className="text-center">Matchup Overview</h2>
                    <p className="card-text">
                    A game-day view showing the Hornets’ matchup against the Lakers, with records, conference standings, broadcast details, and radio coverage.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-4">
                ...
                >
                  <h2 className="text-center">Team Stats Breakdown</h2>
                  <div className="card-body text-white">
                    <p className="card-text text-white">
                    Detailed statistical breakdown for the game, including categories like points, rebounds, assists, and efficiency to compare both teams.
                    </p>
                  </div>
                  <img
                    src="/assets/images/hornets2.png"
                    alt="Schedule Screen"
                    style={{
                      borderTopLeftRadius: "20px",
                      borderTopRightRadius: "20px",
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6">
                <h2 className="text-left">Player Performance</h2>
                <p>
                Individual leaderboards highlighting top performers for each team, tracking their points, rebounds, and assists contributions.
                </p>
              </div>

              <div className="col-lg-6">
                <img
                  src="/assets/images/hornets3.png"
                  width="425"
            ...
            <div className="row">
              ...
              <div className="col-lg-6 mb-4">
                ...
                >
                  ...
                  <img
                    src="/assets/images/hornets4.png"
                    alt="Team Overview"
                    style={{
                      borderTopLeftRadius: "20px",
                      borderTopRightRadius: "20px",
                  ...
                  />
                  <div className="card-body text-white">
                  <h2 className="text-center">Game Highlights Feed</h2>
                    <p className="card-text">
                    A feed of key plays and moments from the game, delivering live highlights and updates as the matchup unfolds.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-4">
                ...
                >
                  <h2 className="text-center">Team Leaders <br/>Points</h2>
                  <div className="card-body text-white">
                    <p className="card-text text-white">
                    Spotlight on the scoring leaders for the game, showcasing standout players who led their teams in total points.
                    </p>
                  </div>
                  <img
                    src="/assets/images/hornets5.png"
                    alt="Roster List"
                    style={{
                      borderTopLeftRadius: "20px",
                      borderTopRightRadius: "20px",
        ...
        <div className="container-fluid bg-custom py-5">
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6">
                <h2 className="text-left">Team Leaders <br/>Assists</h2>
                <p>
                Focused view on playmaking leaders, showing players who distributed the ball and created scoring opportunities.
                </p>
              </div>

              <div className="col-lg-6">
                <img
                  src="/assets/images/hornets6.png"
                  width="425"
                  alt="Navigation Drawer"
                  class="float-end"
                />
