        ...
        <div className="m-image-large">
          <div className="image">
            <div
              ...
              style={{
                backgroundImage: "url(assets/images/bmw-header.png)",
                width: "100%",
              }}
            />
          </div>
          ...
          <div className="container my-5">
            <div className="row">
              ...
              <div className="col-lg-6 mb-4">
                ...
                >
                  ...
                  <h2 className="text-center">Choose Your Style</h2>
                    ...
                    Pick from bold colors and see real-time pricing as you configure your BMW 330i xDrive Sedan.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mb-4">
                ...
                >
                  <h2 className="text-center">Power Meets Precision</h2>
                  <div className="card-body text-white">
                    <p className="card-text text-white">
                    Explore detailed performance stats like MPG, horsepower, and acceleration—all at your fingertips.
                    </p>
                  </div>
                  <img
                    src="/assets/images/bmw1.png"
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6">
                <h2>Discover Every Detail</h2>
                <p>
                Dive into specs, emissions, and interior gallery views to fully experience the BMW driving standard.
                </p>
              </div>

              <div className="col-lg-6">
                <img
                  src="/assets/images/bmw3.png"
                  width="425"
                  alt="Discover Every Detail"
                  class="float-end"
                />
              </div>
            </div>
